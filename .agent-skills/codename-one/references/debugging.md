...
| Command | Purpose |
| --- | --- |
| `stop in net.informaticalibera.streakapp.StreakApp.runApp` | Breakpoint on a method entry. |
| `stop at net.informaticalibera.streakapp.LoginForm:42` | Breakpoint at source line 42. |
...
5. **Set the breakpoint, then continue**: at the `jdb >` prompt:
   ...
   ```
   stop at net.informaticalibera.streakapp.LoginForm:42
   cont
   ```
