...
```
~/.codenameone/<package.StreakApp>/   (Mac/Linux)
%APPDATA%\.codenameone\<package.StreakApp>\   (Windows)
```
...
rm ~/.codenameone/net.informaticalibera.streakapp.StreakApp/settings-screen.png
