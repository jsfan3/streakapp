 ...
 * <p>
 * CN1 already offers {@link Label#setAutoSizeMode(boolean)}, but the app needs a more
...
public final class AutoShrinkSupport {
    private static final String CONFIGURED_KEY = "streakApp.autoShrinkConfigured";
    private static final String ORIGINAL_FONT_KEY = "streakApp.autoShrinkOriginalFont";
    private static final String INSTALLED_KEY = "streakApp.autoShrinkInstalled";
    private static final String SIDE_MENU_COMMANDS_KEY = "streakApp.autoShrinkSideMenuCommands";
